...
<head>
    ...
    <title>Admin SDN Polehan 5</title>
    ...
    <div class="main-container">
        <div class="menu">
            ...
            <ul class="menu-list">
                ...
                <a href="<?php echo base_url('KelolaProfile');?>"><li class="menu-item <?php if ($page == 'kelolaProfile') { echo 'active'; } ?>"><div></div><i class="fas fa-id-card"></i></li></a>
                <a href="<?php echo base_url('KritikSaran')?>"><li class="menu-item <?php if ($page == 'kritikSaran') { echo 'active'; } ?>"><div></div><i class="fas fa-comment"></i></li></a>
